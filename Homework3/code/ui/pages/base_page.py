...
class BasePage(object):
    ...
    def login_manual_fill(self, mail, password):
        self.go_to_login_window()
        self.fill_field(self.locators.LOGIN_MAIL_LOCATOR, mail)
        self.fill_field(self.locators.LOGIN_PASSWORD_LOCATOR, password)
        self.click(self.locators.LOGIN_SUBMIT_LOCATOR)
